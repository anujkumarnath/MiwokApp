...
public class FamilyActivity extends AppCompatActivity implements AudioManager.OnAudioFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                releaseMediaPlayer();
                int result = mAudioManager.requestAudioFocus(FamilyActivity.this, AudioManager.STREAM_MUSIC, AudioManager.AUDIOFOCUS_GAIN_TRANSIENT);
    ...
    private void releaseMediaPlayer() {
        if (mMediaPlayer != null) {
            ...
            mAudioManager.abandonAudioFocus(FamilyActivity.this);
            mMediaPlayer = null;
        }
    }
